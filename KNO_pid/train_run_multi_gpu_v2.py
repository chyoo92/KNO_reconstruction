...
def main_worker(rank,args):
    ...
    for epoch in range(nEpoch):
        ...
        print(trn_loss,'trn_loss'+str(local_gpu_id))
        print(trn_acc,'trn_acc'+str(local_gpu_id))
        ...
        val_loss /= nProcessed
        val_acc /= nProcessed
        print(val_loss,'val_loss'+str(local_gpu_id))
        print(val_acc,'val_acc'+str(local_gpu_id))
