...
class SAKER_v2(nn.Module):
    def __init__(self,**kwargs):
        super(SAKER_v2, self).__init__()
        ...
        self.encoderlayer = torch.nn.TransformerEncoderLayer(d_model=self.dim_model, nhead = self.n_heads, dim_feedforward = self.pf_dim, dropout = self.dropout_ratio, activation = "relu",batch_first=True,norm_first=False)
