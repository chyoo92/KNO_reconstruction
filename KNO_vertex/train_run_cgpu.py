...
from datasets.dataset_v5 import *
dset = dataset_v5()
...
trnLoader = DataLoader(trnDset, batch_size=config['training']['batch'], shuffle=True, num_workers=config['training']['nDataLoaders'],pin_mamory=True)
valLoader = DataLoader(valDset, batch_size=config['training']['batch'], shuffle=False, num_workers=config['training']['nDataLoaders'],pin_mamory=True)
